...
Ling 3 (Update Confucius Prompt & Tools)
    ↓
Ling 4 (Remove Censor from Shogunate)
    ↓
...
insert_ling(id="ling_04_remove_censor_instantiation", title="Remove Censor from Shogunate Minister Registry", description="Edit shogunate/shogunate.go line 120 to remove: s.ministers[\"censor\"] = NewCensor(...). Ensure shogunate compiles with 5 ministers instead of 6.", dependencies=["ling_02_migrate_to_confucius"], testable="shogunate.go compiles; grep confirms no NewCensor instantiation; minister count is 5")
