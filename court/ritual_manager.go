...
func (rg *RitualGuard) PublishEvent(key storage.EdictKey, eventType storage.CourtEvent, payload storage.JSON) uint {
	if rg.db != nil {
...
func (rg *RitualGuard) Subscribe(eventType storage.CourtEvent, handler EventHandler) {
